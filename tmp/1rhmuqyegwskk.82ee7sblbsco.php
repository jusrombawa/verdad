...
<body>
  ...
  <div class="container">
    <h5>Your article will load here</h5>

    <p>
      Click on the "Read Article" buttons to start reading the articles. Click on another "Read Article" button to read another article. Click on the article title to show its details and current reviews.
    </p>
  </div>
