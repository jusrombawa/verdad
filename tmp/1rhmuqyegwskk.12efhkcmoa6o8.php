...
<body>
  ...
  <?php if ($SESSION['user'] != null): ?>
    <div id="art-submit-modal-button" class="fixed-action-btn right-align">
      <a class="btn-floating btn-large waves-effect waves-light blue darken-3 modal-trigger tooltipped" data-position="left" data-tooltip="Submit an article" href="#article-submit-modal"><i class="material-icons">add</i></a>
    </div>
  <?php endif; ?>
