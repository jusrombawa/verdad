...
<body>
  ...
  <div id="title_header" class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center blue-text text-darken-3">Verdad</h1>
      <div class="row center">
        <h5 class="header col s12 light">An online peer-review system for news articles</h5>
      </div>
      <div class="row center">
        <button id="read_button" class="btn-large waves-effect waves-light blue darken-3">Start reading articles</a>
      </div>
      <br><br>
  ...
  <?php if ($SESSION['user'] != null): ?>
    <div id="art-submit-modal-button" class="fixed-action-btn right-align">
      <a id="art-submit-fab" class="btn-floating btn-large waves-effect waves-light blue darken-3 modal-trigger tooltipped" data-position="left" data-tooltip="Submit an article" href="#article-submit-modal"><i class="material-icons">add</i></a>
    </div>
  <?php endif; ?>
